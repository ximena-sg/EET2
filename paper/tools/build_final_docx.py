...
ABSTRACT = ("In institutional and educational network infrastructures, the coexistence of equipment from "
            ...
            "algorithm based on static configuration analysis with confidence-graded link classification; and "
            ...
            "legacy devices, allowing the software to be certified without operational risk. Results from the "
            "pilot deployment show a reduction of per-device backup time from 5-15 minutes to 15-45 seconds, "
            "full-network unattended backup in under 4 minutes, a mean time to recovery below 2 minutes, and "
            "a fully auditable configuration history with no false-positive commits. The engineering rationale "
            "for a purpose-built solution over reference tools such as Oxidized, the operational constraints "
            "assumed, and future lines of work are also discussed.")
...
RES_62 = "During the initial phase, widely adopted tools - particularly Oxidized [1] - were evaluated against the requirements of the legacy park. Table 4 synthesizes the technical rationale that motivated a purpose-built solution."
